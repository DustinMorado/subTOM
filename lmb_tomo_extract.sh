...
# will_lsf_multitomo_subtomogram_extract_stats2
#
...
tomo_folder="${bstore1}/VMV013/20170404/data/tomos/bin2"
...
rootdir="${nfs6}/VMV013/20170404/subtomo/bin2/even"
...
subtomosize=128
## Leading zeros for subtomograms.
## For AV3, use 1. Other numbers are useful for DYNAMO.
subtomo_digits=1
...
time \${execdir}/will_lsf_multitomo_subtomogram_extract_stats2 \\
    ${tomo_folder} ${tomo_digits} ${rootdir} ${tomo_row} \\
    ${subtomoname} ${subtomo_digits} ${allmotlfilename} \\
    ${subtomosize} ${statsname} ${checkstartname} ${checkdonename}
rm -rf ${rootdir}/${mcrcachedir}/${job_name}_\${SGE_TASK_ID}
JOBDATA
