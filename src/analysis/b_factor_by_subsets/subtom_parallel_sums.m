...
% SUBTOM_PARALLEL_SUMS subsets version of parallel sums for finding B-factor.
%
...
%##############################################################################%
    ...
    for subset_idx = 1:num_subsets
        ...
        weight_sum_fn = sprintf('%s_%d_%d_subset%d.em', ...
            weight_sum_fn_prefix, iteration, process_idx, subset_idx);
