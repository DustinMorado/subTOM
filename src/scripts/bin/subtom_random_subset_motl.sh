...
mcr_cache_dir_="${mcr_cache_dir}/random_subset_motl"
...
printf "# Random Subset of Motive List\n" >> subTOM_protocol.md
printf -- "-------------------\n" >> subTOM_protocol.md
...
printf "| %-25s | %25s |\n" "random_subset_motl_exec" \
    "${random_subset_motl_exec}" >> subTOM_protocol.md
...
printf "| %-25s | %25s |\n" "subset_size" "${subset_size}" >> subTOM_protocol.md
printf "| %-25s | %25s |\n\n" "subset_row" "${subset_row}" >> subTOM_protocol.md
