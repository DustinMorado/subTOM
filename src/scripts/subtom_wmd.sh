...
par_coeff_exec="${exec_dir}/classification/wmd/subtom_parallel_coeffs"

# Final Coefficient executable.
coeff_exec="${exec_dir}/classification/wmd/subtom_join_coeffs"
...
par_dmatrix_exec="${exec_dir}/classification/wmd/subtom_parallel_dmatrix"

# Final D-Matrix executable.
dmatrix_exec="${exec_dir}/classification/wmd/subtom_join_dmatrix"
...
dmatrix_fn_prefix="class/dmatrix_wmd"
...
################################################################################
# Relative path and name prefix of the Singular Values.
eig_val_fn_prefix="class/eigval_wmd"

# Relative path and name prefix of the "Eigenvolumes".
eig_vol_fn_prefix="class/eigvol_wmd"

# Relative path and name prefix of the calculated variance map.
variance_fn_prefix="class/variance_wmd"
...
coeff_fn_prefix="class/eigcoeff_wmd"
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]
then
    ${exec_dir}/scripts/subtom_wmd.sh "$(realpath $0)"
else
