function parallel_sums_subsets(ptcl_start_idx, avg_batch_size, iteration, ...
    allmotl_fn_prefix, ref_fn_prefix, ptcl_fn_prefix, tomo_row, ...
    weight_fn_prefix, weight_sum_fn_prefix, iclass, process_idx)
% PARALLEL_SUMS_SUBSETS subsets version of parallel sums for finding B-factor.
%     PARALLEL_SUMS_SUBSETS(
%         PTCL_START_IDX,
%         AVG_BATCH_SIZE,
%         ITERATION,
%         ALLMOTL_FN_PREFIX,
...
%
% Example:
%     PARALLEL_SUMS_SUBSETS(1, 100, 3, 'combinedmotl/allmotl', 'ref/ref', ...
...
%
% See also PARALLEL_SUMS WEIGHTED_AVERAGE_SUBSETS
