...
ldpath="/public/matlab/jbriggs/sys/opengl/lib/glnxa64"
ldpath="/public/matlab/jbriggs/sys/os/glnxa64:\${ldpath}"
ldpath="/public/matlab/jbriggs/bin/glnxa64:\${ldpath}"
ldpath="/public/matlab/jbriggs/runtime/glnxa64:\${ldpath}"
